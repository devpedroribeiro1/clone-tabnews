...
function Home() {
  return (
    <>
      <h1 style={{display: "inline-block", fontFamily: "cursive", backgroundColor: "#00ace2", color: "white", padding: 10, borderRadius: 7}}>DevTeens</h1>
      <hr />
      <div style={{fontFamily: "Arial", fontWeight: "500"}}>
        <p>Desde os nove anos estudo programação e, desde o início dos meus
        estudos, tive contato com poucos adolescentes ou jovens <strong>na minha faixa
        etária</strong> que estivessem à minha frente na programação. Isso não se deve à
        minha "<strong>super mega capacidade de programar</strong>", mas à falta de visibilidade
        e contato que <strong>jovens programadores</strong> têm dentro mercado de tecnologia e
        softwares. <strong>Programadores jovens existem</strong>, mas na maioria das vezes não
        conseguem se conectar e mostrar seu potencial ao mundo. <br/><br/> Por isso, eu, Pedro Ribeiro, estou criando um <strong>espaço na internet onde jovens programadores possam interagir</strong>. Um espaço na
      ...
      <Image
        ...
        style={{ maxWidth: "90%", height: "auto", borderRadius: 7, border: "5px solid #00ace2"}}
      />
    </>
  );
}
